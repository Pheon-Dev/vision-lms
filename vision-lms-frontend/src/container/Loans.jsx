import { Approvals, Pending, Disbursements, Disburse, MaintenanceDetail, Approve, LoansFeed, Payments, Maintenance, CreateLoan, Products, Preview, NewProduct, Submissions } from '../components/Loan';
