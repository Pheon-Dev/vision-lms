...
export default function GeneralReport() {
  ...
  //         <style>.checkbox:onChange + .check-icon {
  //   display: flex;
  // }
  // </style>
              ...
              <table className="w-full whitespace-nowrap">
                <tbody>
                  {members && members?.map((member) => (
                    <tr tabIndex="0" key={member?.memberId} className="focus:outline-none h-16 border border-gray-100 rounded">
                      <td>
                        <div className="ml-5">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {members && members?.map((member) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{member?.officerName}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
      ...
      <>
        ...
        <div className="table w-full p-2">
          <table className="w-full border">
            ...
            <tbody>
              {members && members?.map((member) => (
                <tr key={member?.memberId} className="bg-gray-100 text-center border-b text-sm text-gray-600">
