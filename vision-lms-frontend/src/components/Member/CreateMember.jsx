      ...
      <div className="w-full mt-5">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full md:w-1/2 px-3">
            ...
            <input
              className="uppercase appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
              id="idPass"
              type="text"
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <select
              onChange={(e) => { setGender(e.target.value); (e.target.value) }} className="outline-none w-4.5 text-base border-gray-200 p-2 rounded-md cursor-pointer"
            >
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full md:w-1/2 px-3">
            ...
            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
              id="emailAddress"
              type="email"
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full md:w-full px-3">
            ...
            <input className="uppercase appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
              id="mpesaTransNumber"
              type="text"
